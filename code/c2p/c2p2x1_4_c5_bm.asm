...
;bm_Planes dc.l screen_mem1,screen_mem1+screenBuffer_lineSize,screen_mem1+(2*screenBuffer_lineSize),screen_mem1+(3*screenBuffer_lineSize)
...
;	move.w	bm_BytesPerRow(a1),d4
	move.w	#screenBuffer_lineSize,d4
	...
	;movem.l	bm_Planes,a3-a6	; Setup ptrs to bpl0-3
	
	move.l Screen_RENDER,a3
	move.l a3,a4
	add.l #screenBuffer_width_Byte,a4
	move.l a4,a5
	add.l #screenBuffer_width_Byte,a5
	move.l a5,a6
	add.l #screenBuffer_width_Byte,a6
