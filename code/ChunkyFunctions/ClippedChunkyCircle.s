;APS00016A1E00016A1E00016A1E0001430500016A1E00016A1E00016A1E00016A1E00016A1E00016A1E
******************************************************************************
...
.NoYAbovePH:
	add	(a1,d4.w*2),a1	;Which Function to use
	move.l	d5,d4		;pixelwidth
	move.l	a1,-(a7)
	move	d3,d5		;Size
	lea	CircleMultab+MAXHEIGHT*4(pc),a1
	move	a6,-(a7)	;Color
	move.l	(a1,a5.w*4),a5	;MaxY for clipping is pixelheight
	move.l	a0,a3		;ChunkyScreen
	add.l	a0,a5		;+ChunkyScreen
	move.l	a0,a2		;MinY for clipping is 0 (ChunkyScreen)
	lea	(a1,a4.w*4),a1	;First Offset in Multab we need is Y
	move.l	a0,a6		;ChunkyScreen
	add.l	(a1),a0		;+Y*pixelwidth
	add.l	(a1,d5.w*4),a3	;+Size*pixelwidth
	move	d5,d3		;Size
	moveq	#0,d0		;LowX
	neg	d3
	move.l	a0,a4
	add.l	(a1,d3.w*4),a6	;+-Size*pixelwidth
	moveq	#2,d1		;Loopvar
	move	d3,d6		;-Size
