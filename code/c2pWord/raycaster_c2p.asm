...
.clipX0Done:	
	...
	add.l d0,a0		;MAP_XX0
	add.l d0,a0		; two time because of words now
...
.countClipsX0:
	...
	ifd WALL_TEXTURE_HEIGHT
		mulu.w #WALL_TEXTURE_HEIGHT*2,d0		; *2 because of words
	else
		lsl.w #7,d0		;* Texture width (64*2 pixel=6 left shifts)
	endif
	adda.l d0,a6
	dbf d2,.countClipsX0
.countSkip	
...
.hLoop:
	...
	move.w (a5)+,d7
	ifd WALL_TEXTURE_HEIGHT
		mulu.w #WALL_TEXTURE_HEIGHT*2,d7		; *2 because of Words
	else
		lsl #7,d7	; *64*2 pixel texture height
	endif
	adda.l d7,a6
